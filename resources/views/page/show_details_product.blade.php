						...
						<div class="row">
							<div class="col-sm-4">
								<div class="logo pull-left">
									<a href="{{URL::to('/trang-chu')}}"><img src="{{ asset('/fontend/images/home/logo.png')}}" alt="" /></a>
								</div>
								...
								<div class="panel-group category-products" id="accordian"><!--category-productsr-->
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title"><a href="{{URL::to('danh-muc-san-pham/'.$item->id)}}">{{$item->category_name}}</a></h4>
										</div>
									</div>
									@endforeach
								...
								<div class="brands_products"><!--brands_products-->
									...
									<div class="brands-name">
										<ul class="nav nav-pills nav-stacked">
											...
											<li><a href="{{URL::to('thuong-hieu-san-pham/'.$item->id)}}"> <span class="pull-right">(50)</span>{{$item->brand_name}}</a></li>
											@endforeach
										</ul>
									</div>
								</div><!--/brands_products-->
								...
								<div class="col-sm-7">
									<form action="{{URL::to('cart')}}" method="post">
										...
										<div class="product-information"><!--/product-information-->
											...
											<p> <img src="{{ asset('fontend/images/product-details/rating.png')}}" alt="" /> </p>
											<span>
											...
											<p>
												...
												<input name="product_id" type="hidden" min="1" value="{{$item->id}}" />
				...
				<div class="footer-bottom">
					<div class="container">
						<div class="row">
							...
							<p class="pull-right">Designed by <span><a target="_blank" href="https://www.facebook.com/duong.buitat.10/">BT</a></span></p>
						</div>
					</div>
				</div>
